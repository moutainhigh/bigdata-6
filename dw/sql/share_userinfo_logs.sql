create table dw_qlml.share_userinfo_logs201706(user_id string,addtime string,type string,add_ip string,productcode string,channel string,xin_info string,old_info string,status string,fromChannel string)
