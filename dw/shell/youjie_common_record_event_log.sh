...
then
    ...
    do
        ...
        beeline -u "jdbc:hive2://master2:10000/" -n gongshaojie -w /data2/gsj/beelinepwd.txt  -e "set hive.exec.parallel=true;
            ...
            select * from ee.common_record_event_log where dt='$i' and domain='';
