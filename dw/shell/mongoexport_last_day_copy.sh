...
task_id=`date -d now +"%Y%m%d%H%M%S"`"_$1"
...
then
    ...
    if [ $? -eq 0 ]; then
        ...
        lbs_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','lbs','${start_time}','${lbs_end_time}','${lbs_cost_time}','1')"
        ...
        lbs_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','lbs','${start_time}','${lbs_end_time}','${lbs_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${lbs_insert_sql}"
    fi
...
then
    ...
    if [ $? -eq 0 ]; then
        ...
        ncallrecords_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','ncallrecords','${start_time}','${ncallrecords_end_time}','${ncallrecords_cost_time}','1')"
        ...
        ncallrecords_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','ncallrecords','${start_time}','${ncallrecords_end_time}','${ncallrecords_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${ncallrecords_insert_sql}"
    fi
...
then
    ...
    if [ $? -eq 0 ]; then
        ...
        ncontacts_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','ncontacts','${start_time}','${ncontacts_end_time}','${ncontacts_cost_time}','1')"
        ...
        ncontacts_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','ncontacts','${start_time}','${ncontacts_end_time}','${ncontacts_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${ncontacts_insert_sql}"
    fi
...
then
    ...
    if [ $? -eq 0 ]; then
        ...
        nsms_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','nsms','${start_time}','${nsms_end_time}','${nsms_cost_time}','1')"
        ...
        nsms_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','nsms','${start_time}','${nsms_end_time}','${nsms_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${nsms_insert_sql}"
    fi
...
then
    ...
    if [ $? -eq 0 ]; then
        ...
        mobile_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','mobile','${start_time}','${mobile_end_time}','${mobile_cost_time}','1')"
        ...
        mobile_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','mobile','${start_time}','${mobile_end_time}','${mobile_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${mobile_insert_sql}"
    fi
    ...
    if [ $? -eq 0 ]; then
        ...
        share_userinfo_logs_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','share_userinfo_logs','${start_time}','${share_userinfo_logs_end_time}','${share_userinfo_logs_cost_time}','1')"
        ...
        share_userinfo_logs_insert_sql="insert into ${TABLENAME}(task_id,service_ip,db_name,table_name,start_time,end_time,cost_time,status) values('${task_id}','10.15.168.4','mobp2p','share_userinfo_logs','${start_time}','${share_userinfo_logs_end_time}','${share_userinfo_logs_cost_time}','0')"
        mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} ${DBNAME} -e  "${share_userinfo_logs_insert_sql}"
    fi
    echo "`date "+%Y-%m-%d %H:%M:%S"` $1 To hive has done " >> $logfile
fi
